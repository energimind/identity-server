...
//
// It implements the service.ApplicationService interface.
//
...
// Ensure service implements the service.ApplicationService interface.
var _ admin.ApplicationService = (*ApplicationService)(nil)

// GetApplications implements the service.ApplicationService interface.
//
...
// GetApplication implements the service.ApplicationService interface.
//
//nolint:wrapcheck // see comment in the header
...
// CreateApplication implements the service.ApplicationService interface.
//
//nolint:wrapcheck // see comment in the header
...
// UpdateApplication implements the service.ApplicationService interface.
//
//nolint:wrapcheck // see comment in the header
...
// DeleteApplication implements the service.ApplicationService interface.
//
//nolint:wrapcheck // see comment in the header
