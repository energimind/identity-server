...
// a user or a daemon.
//
// It implements the admin.APIKeyLookupService interface.
//
...
// Ensure service implements the admin.APIKeyLookupService interface.
var _ admin.APIKeyLookupService = (*APIKeyLookupService)(nil)

// LookupAPIKey implements the admin.APIKeyLookupService interface.
//
